...
namespace IE::Core { template<typename> class MultiDimensionalVector; }

template<typename StoredType> class IE::Core::MultiDimensionalVector {
public:
	...
	template<typename ...Args> explicit MultiDimensionalVector<StoredType>(Args... t_args) : m_data{},
																							 m_dimensions() {
	...
	explicit MultiDimensionalVector<StoredType>(std::vector<size_t> t_dimensions) : m_data{},
	...
	template<typename IndexType> IE::Core::MultiDimensionalVector<StoredType> operator[](std::initializer_list<std::initializer_list<IndexType>> t_points) {
	...
	template<typename IndexType> StoredType &operator[](std::initializer_list<IndexType> point) {
