...
IE::Core::Instance::Instance(
  const std::shared_ptr<IE::Core::Asset>  &t_asset,
  const std::shared_ptr<IE::Core::Aspect> &t_aspect
) :
        m_asset(t_asset),
        m_aspect(t_aspect) {
}

std::shared_ptr<IE::Core::Instance> IE::Core::Instance::Factory(
  const std::shared_ptr<IE::Core::Asset>  &t_asset,
  const std::shared_ptr<IE::Core::Aspect> &t_aspect
) {
