...
public:
    ...
    public:
        ...
        Version version{"0.0.0"}; // Should be set to the lowest supported OpenGL version.
        ...
        Version getVersion() {
            ...
            if (name == "OpenGL") {
                ...
                else if (GLEW_VERSION_1_2) { version = Version{"1.2.0"}; }
                else if (GLEW_VERSION_1_2_1) { version = Version{"1.2.1"}; }
                else if (GLEW_VERSION_1_3) { version = Version{"1.3.0"}; }
                else if (GLEW_VERSION_1_4) { version = Version{"1.4.0"}; }
                else if (GLEW_VERSION_1_5) { version = Version{"1.5.0"}; }
                else if (GLEW_VERSION_2_0) { version = Version{"2.0.0"}; }
                else if (GLEW_VERSION_2_1) { version = Version{"2.1.0"}; }
                else if (GLEW_VERSION_3_0) { version = Version{"3.0.0"}; }
                else if (GLEW_VERSION_3_1) { version = Version{"3.1.0"}; }
                else if (GLEW_VERSION_3_2) { version = Version{"3.2.0"}; }
                else if (GLEW_VERSION_3_3) { version = Version{"3.3.0"}; }
                else if (GLEW_VERSION_4_0) { version = Version{"4.0.0"}; }
                else if (GLEW_VERSION_4_1) { version = Version{"4.1.0"}; }
                else if (GLEW_VERSION_4_2) { version = Version{"4.2.0"}; }
                else if (GLEW_VERSION_4_3) { version = Version{"4.3.0"}; }
                else if (GLEW_VERSION_4_4) { version = Version{"4.4.0"}; }
                else if (GLEW_VERSION_4_5) { version = Version{"4.5.0"}; }
                else if (GLEW_VERSION_4_6) { version = Version{"4.6.0"}; }
