...
class RenderEngine final : public IE::Core::Engine, private std::enable_shared_from_this<RenderEngine> {
private:
    ...
    GLFWwindow           *m_window{};
    std::array<size_t, 2> defaultResolution{800, 600};
    std::array<size_t, 2> currentResolution = defaultResolution;
    std::array<size_t, 2> defaultPosition{10, 10};
    bool                  useVsync{false};
