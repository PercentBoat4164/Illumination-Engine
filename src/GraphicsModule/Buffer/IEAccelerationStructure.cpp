...
void IEAccelerationStructure::create(IERenderEngine *renderEngineLink, IEAccelerationStructure::CreateInfo *createInfo) {
//	linkedRenderEngine = renderEngineLink;
//	createdWith = *createInfo;
//	VkAccelerationStructureBuildGeometryInfoKHR accelerationStructureBuildGeometryInfo{
//			VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_GEOMETRY_INFO_KHR};
//	IEBuffer instancesBuffer{};
...
//		accelerationStructureGeometry.geometry.triangles.vertexStride = sizeof(IEVertex);
...
//				createdWith.bottomLevelAccelerationStructureDeviceAddresses.size()};
...
//		}
//		IEBuffer::CreateInfo instanceBufferCreateInfo{};
//		instanceBufferCreateInfo.size =
//				sizeof(VkAccelerationStructureInstanceKHR) * createdWith.bottomLevelAccelerationStructureDeviceAddresses.size();
...
//		instancesBuffer.uploadData(accelerationStructureInstance.data(),
//								   sizeof(VkAccelerationStructureInstanceKHR) * createdWith.bottomLevelAccelerationStructureDeviceAddresses.size());
...
//	linkedRenderEngine->vkGetAccelerationStructureBuildSizesKHR(linkedRenderEngine->device.device, VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR,
//																&accelerationStructureBuildGeometryInfo,
//																createdWith.type == VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR
//																? &createdWith.primitiveCount : &count, &accelerationStructureBuildSizesInfo);
...
//	linkedRenderEngine->vkCreateAccelerationStructureKHR(linkedRenderEngine->device.device, &accelerationStructureCreateInfo, nullptr,
//														 &accelerationStructure);
//	deletionQueue.emplace_back(
//			[&] { linkedRenderEngine->vkDestroyAccelerationStructureKHR(linkedRenderEngine->device.device, accelerationStructure, nullptr); });
//	VkAccelerationStructureDeviceAddressInfoKHR accelerationStructureDeviceAddressInfo{
//			VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR};
//	accelerationStructureDeviceAddressInfo.accelerationStructure = accelerationStructure;
//	deviceAddress = linkedRenderEngine->vkGetAccelerationStructureDeviceAddressKHR(linkedRenderEngine->device.device,
//																				   &accelerationStructureDeviceAddressInfo);
//	IEBuffer::CreateInfo scratchBufferCreateInfo{accelerationStructureBuildSizesInfo.accelerationStructureSize,
...
//			createdWith.type == VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR ? createdWith.primitiveCount : count;
...
//	linkedRenderEngine->vkCmdBuildAccelerationStructuresKHR(linkedRenderEngine->graphicsCommandPool[0].commandBuffer, 1,
//															&accelerationStructureBuildGeometryInfo, pAccelerationStructureBuildRangeInfo.data());
...
IEAccelerationStructure::IEAccelerationStructure() = default;
