...
IE::Graphics::detail::TextureOpenGL::TextureOpenGL() noexcept:
		m_unit{} {}
...
IE::Graphics::detail::TextureOpenGL &IE::Graphics::detail::TextureOpenGL::operator=(TextureOpenGL &&t_other) noexcept {
	if (&t_other != this) {
		m_unit = std::exchange(t_other.m_unit, 0);
	}
	return *this;
}

IE::Graphics::detail::TextureOpenGL &IE::Graphics::detail::TextureOpenGL::operator=(const IE::Graphics::detail::TextureOpenGL &t_other) {
	if (&t_other != this) {
		m_unit = t_other.m_unit;
	}
	return *this;
}
