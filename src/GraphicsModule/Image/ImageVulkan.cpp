  ...
  std::vector<unsigned char> &t_data
    ...
    VkImageCreateInfo imageCreateInfo{
      ...
      .usage       = static_cast<VkImageUsageFlags>(
        intentFromPreset(m_preset) == IE_IMAGE_INTENT_COLOR ? VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT :
    ...
    VkImageViewCreateInfo imageViewCreateInfo{
      ...
      .subresourceRange = VkImageSubresourceRange{
          ...
          intentFromPreset(m_preset) == IE_IMAGE_INTENT_COLOR ? VK_IMAGE_ASPECT_COLOR_BIT :
