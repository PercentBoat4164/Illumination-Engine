...
public:
    ...
    void create(IERenderEngineLink *renderEngineLink, CreateInfo *createInfo) {
        linkedRenderEngine = renderEngineLink;
        createdWith = *createInfo;
        /**@todo Remove the asserts here.*/
        #ifdef ILLUMINATION_ENGINE_VULKAN
        if (createdWith.maxIndex > 1) { assert(linkedRenderEngine->physicalDevice.enabledAPIComponents.descriptorIndexingFeatures.descriptorBindingVariableDescriptorCount); }
