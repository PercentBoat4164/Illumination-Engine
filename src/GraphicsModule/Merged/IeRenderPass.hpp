...
public:
    ...
    void create(IeRenderEngineLink *engineLink) {
...
void IeFramebuffer::create(IeRenderEngineLink *engineLink, CreateInfo *createInfo, IeRenderPass *containerRenderPass) {
    ...
    VkFramebufferCreateInfo framebufferCreateInfo{.sType=VK_STRUCTURE_TYPE_FRAMEBUFFER_CREATE_INFO, .renderPass=createdWith.renderPass.renderPass};
