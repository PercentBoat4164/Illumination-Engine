...
int main(int argc, char **argv) {
    ...
    IEScript script{fileSystem.getFile("res/Scripts/script.lua")};
    asset.addAspect(&script);
    ...
    printf("%s\n%s\n%li\n", script.deduceLanguage().c_str(), script.file->read(script.file->length).c_str(), script.file->length);
    script.compileInPlace();
