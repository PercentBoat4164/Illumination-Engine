...
std::string absolutePath = path.substr(0, path.find_last_of("\\") + 1);
#else
...
const std::string MODEL_PATH = absolutePath + "models/viking_room.obj";
const std::string TEXTURE_PATH = absolutePath + "textures/viking_room.png";
