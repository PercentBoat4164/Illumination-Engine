...
const std::string MODEL_PATH = "/home/thaddeus/Documents/Programming/C++/GameEngine/models/viking_room.obj";
const std::string TEXTURE_PATH = "/home/thaddeus/Documents/Programming/C++/GameEngine/textures/viking_room.png";
...
private:
    ...
    void initWindow() {
        ...
        window = glfwCreateWindow(WIDTH, HEIGHT, "Game Engine Renderer", nullptr, nullptr);
    ...
    void createInstance() {
        ...
        appInfo.pApplicationName = "Game Engine Renderer";
    ...
    static void framebufferResizeCallback(GLFWwindow* window, int width, int height) {
        auto app = reinterpret_cast<GameEngineRenderer*>(glfwGetWindowUserPointer(window));
    ...
    static std::vector<char> readFile(const std::string& filename) {
        ...
        #endif
        std::ifstream file(filenameAbsolute + '/' + filename, std::ios::ate | std::ios::binary);
