...
namespace geometryFunctions {
    ...
    class Shape {
        public:
            ...
            virtual bool isIntersecting(Shape otherShape) {
                return isInside(otherShape.getClosestPoint);
            }
        ...
        public:
            ...
            bool isInside(glm::vec3 point) {
                ...
                glm::mat4 potentialPlane = glm::mat4(
                    ...
                    glm::vec4(target.x, target.y, target.z, 1));

                //make sure the point is on the plane
                return glm::determinant(potentialPlane) < geommetryConstants::minError) 
            }
    ...
    class LineSegment : Shape {
        public:
            ...
            bool isInside(glm::vec3 target) {
                return geometryFuntions::distLinePoint(position, position + segment, target) == 0;
            }

            bool isIntersecting(Shape otherShape) {
                return geometryFunctions::distLinePoint(position, b, otherShape.getClosestPoint()) == 0;
            }

            glm::vec3 getClosestPoint(glm::vec3 target) {
                pointOnLine = getLengthAlongLine(target);
        ...
        protected:
            ...
            bool isBeforeSegment(glm::vec3 target) {
                return glm::normalize(segment) == -1 * glm::normalize(pointOnLine)
            }
    };
